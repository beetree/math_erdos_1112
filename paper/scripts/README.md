...
verify each witness exactly in integer arithmetic, and validate the certificate tables of Appendix D.
...
- `check_correspondence.py` verifies that every Lean declaration named in the paper's Appendix E
