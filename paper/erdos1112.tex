...
The reciprocal construction, binary alternative and complete finite interval
lemma follow this paper in Lean. The old SHARP proof and certificate tables
have been removed. The density dependency is still being formalized; the
final non-existence theorem temporarily retains the earlier argument, whose
verification does not certify the new Kneser shortcut.
