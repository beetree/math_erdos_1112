...
Everything needed to check this paper is contained in one commit of the repository
\repo. That commit carries this \LaTeX{} source, the Lean~4 development
\cite{Lean4,Mathlib}, the machine-readable certificate exports
