...
The human-readable proof is the paper. The prose files in [`proof/`](proof) were the original
Markdown write-up; they are now **reduced to pointers** to the paper, so that no stale second copy of
